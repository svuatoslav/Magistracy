...
public class Save
{
    ...
    public void SaveGame(/*Data data, */KeplerMethod keplerMethod)
    {
        ...
        //if (keplerMethod == KeplerMethod.Iteration)
        //    filePathE += EClassic;
        //else if (keplerMethod == KeplerMethod.DecompositionDegreesEccentricity)
        //    filePathE += EDDE;
        //else
        //    filePathE += EDM;
